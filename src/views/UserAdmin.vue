<template>
  <div class="container">
    ...
    <table class="table-primary table-bordered" id="table" :style="{backgroundColor:'#4A4A4A', width:'1200px', borderColor:'#000000', borderWidth:'40px', borderStyle:'solid', color: '#ffffff'}">
      ...
      <tbody>
        <tr v-for="user in users" :key="user.userID">
          ...
          <td>{{ user.userAge }}</td>
          <td>
            <button @click="editUser(user)" class="btn" :style="{backgroundColor:'#000000', color:'#ffffff'}">Edit</button>
            <button @click.prevent="deleteUser(user.userID)" class="btn" :style="{backgroundColor:'#000000', color:'#ffffff'}">Delete</button>
          </td>
        </tr>
      </tbody>
    </table>
          ...
          <div class="modal-body">
            <form @submit.prevent="updateUser">
              ...
              <div class="mb-3">
                ...
                <input type="text" v-model="currentUser.lastName" class="form-control" id="lastName" required>
              </div>
              <div class="mb-3">
          ...
          <div class="modal-body">
            <form @submit.prevent="loginUser">
              ...
              <div class="mb-3">
                ...
                <input type="password" v-model="currentUser.userPass" class="form-control" id="password" required placeholder="Password">
              </div>
...
// Update user
const updateUser = () => {
  store.dispatch('editUser', currentUser.value).then(() => {
    showModalEdit.value = false;
    currentUser.value = {};
  });
};
...
<style>
/* Custom modal styling and layout adjustments */
.container {
  max-width: 100%;
  padding: 2rem;
}
